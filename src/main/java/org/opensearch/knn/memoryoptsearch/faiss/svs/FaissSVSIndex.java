 ...
 */
public class FaissSVSIndex extends AbstractFaissHNSWIndex {
    public static final String ISVF = "ISVF"; // static flat - default
    public static final String ISVL = "ISVL"; // LeanVec
    public static final String ISVD = "ISVD"; // uncompressed dynamic vamana
    public static final String ILVQ = "ILVQ"; // LVQ
    ...
    public FaissSVSIndex() {
        super(ISVF, new FaissSVSIndex());
    }
